...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("efactura3Fe");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("efactura3Fe");
        ...
        config.getMapConfigs().put("uy.com.equital.efactura.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
