...
@Configuration
@EnableJpaRepositories("uy.com.equital.efactura.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("uy.com.equital.efactura.application.repository.search")
